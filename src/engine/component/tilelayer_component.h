...
enum class TileType
{
    ...
    NORMAL,     ///< @brief 普通瓦片
    SOLID,      ///< @brief 静止可碰撞瓦片
    UNISOLID,   ///< @brief 单向可碰撞瓦片（例如只能从下往上跳过）
    SLOPE_0_1, SLOPE_1_0, ///< @brief tan=1度坡度
...
class TileLayerComponent final : public Component {
    friend class engine::object::GameObject; ///< @brief 允许 GameObject 访问 TileLayerComponent 的私有成员
private:
